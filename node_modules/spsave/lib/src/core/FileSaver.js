...
var FileSaver = (function () {
    function FileSaver(coreOptions, credentialOptions, fileOptions) {
        ...
        this.file = Object.assign({}, fileOptions);
        this.coreOptions = Object.assign({}, coreOptions);
        this.coreOptions = Object.assign({
            checkin: false,
    ...
    FileSaver.prototype.saveFile = function (requestDeferred, attempts) {
        ...
        var uploadResult = checkoutResult
            ...
            return _this.sprequest.post(_this.uploadFileRestUrl, {
                ...
                responseType: typeof _this.file.fileContent === 'string' ? 'text' : 'buffer'
            });
        });
        Promise.all([checkoutResult, uploadResult])
            ...
            .catch(function (err) {
            var _a, _b, _c, _d, _e;
            if (err && (((_a = err.response) === null || _a === void 0 ? void 0 : _a.statusCode) === 500 || ((_b = err.response) === null || _b === void 0 ? void 0 : _b.statusCode) === 409)) {
                _this.tryReUpload(err, requestDeferred, attempts);
                return;
            }
            if (err && ((_c = err.response) === null || _c === void 0 ? void 0 : _c.statusCode) === 404 && ((_d = err.response) === null || _d === void 0 ? void 0 : _d.body) && ((_e = err.response) === null || _e === void 0 ? void 0 : _e.body.toString().indexOf(FileSaver.directoryNotFoundCode)) !== -1) {
