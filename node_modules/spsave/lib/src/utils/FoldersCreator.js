...
exports.FoldersCreator = void 0;
var UrlHelper_1 = require("./UrlHelper");
var ConsoleLogger_1 = require("./ConsoleLogger");
var Defer_1 = require("./Defer");
var promise_reflect_1 = require("./promise-reflect");
    ...
    FoldersCreator.prototype.createFoldersHierarchy = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            folderPaths.forEach(function (folder) {
                ...
                getFolderPromises.push(_this.sprequest.get(getFolderUrl));
            });
            Promise.all(getFolderPromises.map(promise_reflect_1.reflect))
                .then(function (data) {
                var foldersToCreate = data.map(function (promise, index) {
                    var _a, _b;
                    if (promise.isRejected && (((_a = promise.reason.response) === null || _a === void 0 ? void 0 : _a.statusCode) === 404 || ((_b = promise.reason.response) === null || _b === void 0 ? void 0 : _b.statusCode) === 500)) {
                        return index;
                    }
...
//# sourceMappingURL=FoldersCreator.js.map